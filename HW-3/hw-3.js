...
//Number
console.log(typeof 2018);
//String
console.log(typeof "Javascript is cool, but cats are cooler.");
//Boolean
...
//defining variable fancyPyramid to output # mark, camelCasing for clarity's sake.
for (var fancyPyramid = "#";
//defining pyramid length as 10 or less.
fancyPyramid.length <= 10;
//adding a # to each line that fancyPyramid outputs.
fancyPyramid += "#")
//writing it all to the console!
console.log(fancyPyramid);
